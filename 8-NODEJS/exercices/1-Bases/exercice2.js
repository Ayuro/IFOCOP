...
require('exercice2-module');


// Pour le message du module secondaire on peut aussi le faire comme ça: 
// const msgDeux = require('./exercice2-module');
// console.log(msgDeux);
...
// let result = require('exercice2-module');
