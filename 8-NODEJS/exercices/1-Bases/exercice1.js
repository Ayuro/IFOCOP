...
**/
// console.log("Le nom du fichier exécuté ainsi que son chemin d'accès est: " + global.process.argv[1]);
console.log("Le nom du fichier exécuté ainsi que son chemin d'accès est: " + __filename);
console.log("Le nom du dossier dans lequel le programme s'éxécute est: " + process.execPath);
