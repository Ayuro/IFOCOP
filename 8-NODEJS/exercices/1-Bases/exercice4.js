...
const myDnsIp = dns.getServers();
console.log("L'ip de mon DNS est: ", myDnsIp[0]);
...
dns.lookup("www.fnac.com", (err, hostname, service) => {
    console.log("Et celle-ci est celle de la fnac: ", hostname);
});
...
// dns.lookup("monVoisin", (err, hostname, service) => {
//   console.log("Et celle-ci est celle de mon voisin: ", hostname);
// });
...
let readIt = require('exercice4-module');
