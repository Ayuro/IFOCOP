...
db.piscines.find({zipCode: {$nin: [75015, 75016, 75017]}}).sort({zipCode:-1})
...
// pour le même résultat on peut aussi faire comme ça:
db.piscines.countDocuments({ lon: { $lt: 2.35 } })
